...
class TropicalFlow(nn.Module):
    ...
    def sample_continuous(self, cache: Cache) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        print("WE ARE INSIDE SAMPLE_CONTINUOUS")
        print(f"x: {x}")
        print(f"net_cache: {net_cache}")
...
class TropicalIntegrator:
    def __init__(self, integrand, lr=3e-4, batch_size=10, continuous_kwargs={}, discrete_kwargs={}):
